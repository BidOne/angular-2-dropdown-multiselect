...
var MultiselectDropdown = /** @class */ (function () {
    ...
    Object.defineProperty(MultiselectDropdown.prototype, "selectedNameClasses", {
        get: function () {
    ...
    MultiselectDropdown.prototype.updateTitle = function () {
        ...
        if (this.numSelected === 0 || this.settings.fixedTitle) {
            ...
            this.title = useOptions
                ...
                .map(function (option) {
                if (_this.selectedNameClasses) {
                    return '<span class="' + _this.selectedNameClasses + '">' + option.name + '</span>';
                }
                return option.name;
            })
